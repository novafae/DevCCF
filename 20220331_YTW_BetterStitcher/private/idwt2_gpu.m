function x = idwt2_gpu(a,h,v,d,varargin)
...
x = upsconv2_gpu(a,{Lo_R,Lo_R},sx,dwtEXTM,shift)+ ... % Approximation.
    upsconv2_gpu(h,{Hi_R,Lo_R},sx,dwtEXTM,shift)+ ... % Horizontal Detail.
    upsconv2_gpu(v,{Lo_R,Hi_R},sx,dwtEXTM,shift)+ ... % Vertical Detail.
    upsconv2_gpu(d,{Hi_R,Hi_R},sx,dwtEXTM,shift);     % Diagonal Detail.
